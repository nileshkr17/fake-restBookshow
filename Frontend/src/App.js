      ...
      </div>
{
 ...
 {/* generate an banner with grid two components having slider and intro  */}
      ...
      <Allrouter />
      <Banner />
      <h1 className="text-6xl text-center mt-10 text-black">Hello World</h1>
      <Buy></Buy>// this will be called when a card will be clicked and then booking will be done
